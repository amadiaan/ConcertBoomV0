...
<title><?php echo $name . ' , ' . $artist . ' '. $city . ' tickets '. $year .' | Concertboom'; ?></title>
<meta name="description" content="<?php echo $artistAll . ' concert in ' . $venueName . ', ' . $city . ', date: ' . $month . ' ' . $year . '.'; ?>">
<meta name="keywords" content="<?php echo $name . ', ' . $name . ' tickets, ' . $artist . ', ' . $artist . ' concert' . ', ' . $city . ' concerts' . ', ' . $name . ' ticket' . ', ' . $artist . ' ticket' . ', ' . $artist . ' tour dates'; ?> " >
