...
$checkArtistZV = mysql_query("SELECT * FROM ZV_PERFORMER WHERE performer_slug_cb = '$artistSlug' limit 1 ") or die(mysql_error());
    ...
    <div class="row no-gutters banner py-5">
      <div class="container">
        ...
        <div class="col-lg-3 col-md-4">
          <img src="img/img.jpg" class="img-fluid rounded-circle" style="width: 300px;">
        </div>
        <div class="col-lg-6 col-xl-5 col-md-8" style="padding-left: 30px; padding-right: 0px">
          ...
          <p class="mb-0 d-none d-md-block text-justify pr-lg-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nobis illum dolor voluptates quae vel perspiciatis nam eaque debitis quisquam dignissimos, alias corporis quidem delectus, deserunt facilis perferendis, sed culpa soluta.</p>
        ...
        <div class="mt-5">
          ...
          <h5 class="text-uppercase text-center mt-3 mb-5 mb-md-0">see more</h5>
           ...
           <div class="col-lg-3 col-md-4 similarartist-section">
            ...
            <div class="row">
              <div class="col-6">
                <img src="img/img.jpg" class="img-fluid rounded-circle mt-2">
                <div class="mb-3">
                <span>Date</span><br>
                <span>Location</span>
                </div>
